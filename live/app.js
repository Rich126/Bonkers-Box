(function(){
  ...
  const mixCreativeRounds=Array.isArray(creative.mixRounds)?creative.mixRounds:[];
  ...
  async function createRoom(){
    ...
    if(selectedGame==='mix'&&mixOrder.length<length){msg($('host-message'),'There are not enough quiz or creative rounds for that combination yet. Choose another topic or a shorter game.');return;}
